...
const initialState = {
  data : {
    ...
    d :{
      ...
      name:'d',
      label:"d",
      description: "Distance du c.g des armatures tendues à la fibre la plus comprimée d’une section",
      value: 0.63, 
      unit: {value :"m", label :"m"}
    },
    ...
    dPrime :{
      ...
      name:"d' ",
      label:"d' ",
      description: "Distance du c.g des aciers comprimés à la fibre de béton la plus comprimée",
      value: 0.07, 
      unit: {value :"m", label :"m"}
    },
    // Matériaux
