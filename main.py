...
# Configurer CORS
origins = [
    "http://localhost:3000",  # Remplacez par le port de votre application React si différent
    "http://localhost:3005",  # Ajoutez cette ligne si vous utilisez un port différent
]
